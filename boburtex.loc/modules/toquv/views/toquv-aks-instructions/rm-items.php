<?php use app\modules\toquv\models\ToquvDocuments;
...
foreach ($model as $key => $item):?>
    <tr class="tr_<?=$count?> tr_thread_<?=$count?>_<?=$item['id']?>">
        ...
        <td>
            <?= Html::input('text', "ToquvInstructionRm[$count][child][{$key}][fact]", $percentage, ['class' => 'form-control number required qty_'.$count,'percentage'=>$item->percentage]);?>
        </td>
        <td>
