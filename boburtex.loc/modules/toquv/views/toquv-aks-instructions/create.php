                        ...
                        foreach ($rmItems as $key => $item):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?= Html::textInput("ItemsRM[{$item['troid']}][quantity]", $remain, ['data-qty' => ($item['order_quantity'] - $item['sum']), 'class' => 'quantity required form-control number', 'data-row-index' => $item['troid']]) ?>
                                </td>
                                <td>
                                    <?= Html::textInput("ItemsRM[{$item['troid']}][count]", $item['order_count'], ['class' => 'form-control', 'disabled' => true]) ?>
                                </td>
                                <td>
                                    <?= Select2::widget([
                                ...
                                <td>
                                    <?= Html::textInput("ItemsRM[{$item['troid']}][thread_length]", $item['thread_length'], ['class' => 'form-control number']) ?>
                                </td>
                                <td>
                                    <?= $item['finish_en']; ?>
                                </td>
                                <td>
                                    <?= Html::textInput("ItemsRM[{$item['troid']}][finish_en]", $item['finish_en'], ['class' => 'form-control number']) ?>
                                </td>
                                <td>
                                    <?= $item['finish_gramaj']; ?>
                                </td>
                                <td>
                                    <?= Html::textInput("ItemsRM[{$item['troid']}][finish_gramaj]", $item['finish_gramaj'], ['class' => 'form-control number']) ?>
                                </td>
    ...
    <script>
        ...
        $("body").delegate(".copy","click",function(){
            ...
            rmL.load('<?=$url_thread?>?id=' + t.data('id') + '&order=' + order + '&key=' + last_num + ' #new_table', {}, function () {
                ...
                $("#loadRm").find('.new_thread_qty').val(qty.val()).trigger('change');
