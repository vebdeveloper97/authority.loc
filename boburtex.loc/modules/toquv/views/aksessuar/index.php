...
/* @var $searchModel \app\modules\toquv\models\AksessuarSearch */
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($model){
                        $musteri = (!empty($model['order_musteri']))?" ({$model['order_musteri']})":'';
                        return $model['musteri_id'].$musteri;
                    },
                ...
                [
                    ...
                    'value' => function($model){
                        return $model['mato_color']. " <b>". $model['mato']."</b>";
                    },
                    'format' => 'raw',
                    'filterInputOptions' => [
                ...
                [
                    'attribute' => 'summa',
                    'label' => Yii::t('app', 'Tayyorlangan aksessuar miqdori'),
                    'headerOptions' => [
                        'style' => 'width:70px'
                    ],
                    'contentOptions' => [
                ...
                [
                    'label' => Yii::t('app', 'Sehdagi aksessuar'),
                    'value' => function($m){
                        return ToquvKalite::getOneKalite($m['tir_id'],1, null, 2)['summa'];
                    },
                    'contentOptions' => [
                        'class' => 'summa_seh'
                    ],
                ...
                [
                    'label' => Yii::t('app', 'Omborga jo\'natilgan aksessuar'),
                    'value' => function($m){
                        return ToquvKalite::getOneKalite($m['tir_id'],3, null, 2)['summa'];
                    },
                    'contentOptions' => [
                        'class' => 'summa_ombor'
                    ],
                ...
                [
                    ...
                    'value' => function($model){
                        $diff = $model['quantity'] - $model['summa'] - ToquvKalite::getOneKalite($model['tir_id'],3, null, 2)['summa'];
                ...
                [
                    ...
                    'visibleButtons' => [
                        'view' => Yii::$app->user->can('aksessuar/view'),
                        'save-and-finish' => function($m) {
                            return Yii::$app->user->can('aksessuar/save-and-finish') && ToquvKalite::getOneKalite($m['tir_id'],1, null, 2)['summa']>0;
                        },
                    ],
                    'buttons' => [
                        'view' => function ($url, $m) {
                            return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, [
                                ...
                                'data-form-id' => "{$m['tir_id']}&mato_id={$m['mato_id']}&pus_fine_id={$m['pus_fine_id']}&thread_length={$m['thread_length']}&finish_en={$m['finish_en']}&finish_gramaj={$m['finish_gramaj']}",
                            ]);
                        },
