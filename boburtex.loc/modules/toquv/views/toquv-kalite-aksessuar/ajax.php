...
$this->title = Yii::t('app', 'Toquv Aksesuar Mashinalar Ish Miqdori');
$this->params['breadcrumbs'][] = $this->title;

use yii\web\JsExpression; ?>
    <div class="toquv-kalite-index" style="padding-left: 15px;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel"><?=Yii::t('app','Mashina nomi')?> :  <label><?=$makine->name?></label></h4>
        </div>
        <div class="modal-body">
            <form action="" class="formKalite" method="POST">
                <div class="parentRow">
                    <div class="row parentDiv">
                        <div class="makineTable">
                            ...
                            <div class="col-md-6 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label><?=Yii::t('app','To\'quv masteri')?></label>
                                    <?= \kartik\select2\Select2::widget([
                                        'name' => "Kalite[user_id]",
                            ...
                            <!--<div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <label><?/*=Yii::t('app','Sort Name ID')*/?></label>
                                    <?/*= \kartik\select2\Select2::widget([
                                        'name' => "Kalite[sort_name_id]",
                                        'data' => $makine->sortNameList,
                                        'options' => [
                                            'class' => 'sortNameSelect',
                                            'id' => 'sortNameSelect_'.$makine->id.'_'.$id
                                        ]
                                    ])
                                    */?>
                                </div>
