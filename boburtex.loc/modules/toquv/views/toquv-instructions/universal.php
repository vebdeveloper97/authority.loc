...
<div class="toquv-instructions-view">
    <div class="toquv-instructions-form" style="border: 1px solid #ccc;margin-top: 15px; padding: 5px;">
        ...
        <div class="row">
            <div class="col-md-3">
                <?= $form->field($model, 'model_musteri_id')->widget(Select2::classname(), ['data' => $model->musteriList, 'language' => 'ru', 'options' => [
                    ...
                    [
                        ...
                        'options' => [
                            ...
                            'pluginEvents' => [
                                ...
                                "select2:close" => new JsExpression('function() { $(".list-cell__toquv_rm_order_id .select2-container").css("width","200px") }'),
...
div.form-group .select2-container--krajee .select2-selection--single,.select2-container--krajee .select2-selection--single {
    height: 18px;
    line-height: 1.7;
...
div.form-group .select2-container--krajee .select2-selection__clear,.select2-container--krajee .select2-selection__clear {
    top: 0;
    font-size: 11px;
}
div.form-group .select2-container--krajee span.selection .select2-selection--single span.select2-selection__arrow ,.select2-container--krajee span.selection .select2-selection--single span.select2-selection__arrow {
    height: 16px;
}
.form-control {
    height: 18px;
