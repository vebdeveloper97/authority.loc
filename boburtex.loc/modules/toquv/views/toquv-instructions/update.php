...
$this->params['breadcrumbs'][] = ['label' => $model->toquvOrder->document_number, 'url' => ['view','id'=>$id,'orderId'=>$orderId]];
            ...
            <table class="table table-bordered table-middle">
                ...
                foreach($rmItems as $key=>$item):?>
                    <tr>
                        ...
                        <td>
                            <?= Html::textInput("ItemsRM[{$item['troid']}][quantity]", $item['quantity'], ['data-qty' => ($item['order_quantity']+$item['quantity']-$item['sum']), 'class' => 'quantity form-control required number', 'data-row-index' => $item['troid']]) ?>
                        </td>
                        <td>
                            <?= Select2::widget([
                        ...
                        <td>
                            <?= Constants::getTypeWeaving($item['order_type_weaving']); ?>
                        </td>
                        <td>
            ...
            <table class="table table-bordered table-middle">
                ...
                <?php foreach ($items as $key => $item):?>
                    ...
                    <tr class="tr_<?=$item['tro_id']?> tr_thread_<?=$item['troi_id']?>">
                        <?= Html::hiddenInput("ItemsRM[{$item['tro_id']}][child][{$key}][quantity]", $item['ipqty']);?>
                        ...
                        <td><?= $isOwnLabel; ?></td>
                        <td><?= $item['mato']." - <span class='material_".$item['tro_id']."'>". $item['fact']."</span> kg" ?></td>
                        <td><?= $item['nename']."-".$item['thrname']." - "?> <span class='percentage_<?=$item['tro_id']?>' percentage='<?=$item['percentage']?>'><?=$item['own_qty']?></span> kg</td>
                        ...
                        <td>
                            <?= Html::input('text', "ItemsRM[{$item['tro_id']}][child][{$key}][fact]", $item['fact'], ['class' => 'form-control qty_'.$item['tro_id'],'percentage'=>$item['percentage']]);?>
                        </td>
                        <td>
