...
<?php Pjax::begin(['id' => 'reportResultIncoming'])?>
            ...
            'items' => [
                [
                    ...
                    'content' => $this->render('search/_search_mato', [
                        ...
                        'entity_type' => null,
                        'search_mato' => null,
                        'url' => \yii\helpers\Url::to('report-export-mato-sklad'),
                    ]),
    ...
    <div class="report-ip-title">
        <h3 class="text-center" style="padding-bottom: 25px;">
            ...
            <br>
            (<b><?=\app\modules\toquv\models\ToquvOrders::getOrderTypeList(\app\modules\toquv\models\ToquvOrders::ORDER_EXPORT)?></b>)
        </h3>
    </div>
