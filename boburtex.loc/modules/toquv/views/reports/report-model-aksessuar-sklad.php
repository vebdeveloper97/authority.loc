        ...
        'items' => [
            [
                ...
                'content' => $this->render('search/_search_mato', [
                    ...
                    'url' => Url::to(['report-model-aksessuar-sklad']),
                    'search_mato' => null,
                ]),
...
<div class="report-ip-title">
    <h3 class="text-center" style="padding-bottom: 25px;">
        <?= Yii::t('app', "{name} : {from} - {to} sana oralig'idagi ombordagi aksessuar holati", ['from' => $data['from_date'], 'to' => $data['to_date'], 'name' => $data['name']]) ?>
    </h3>
</div>
