...
<div class="toquv-item-balance-search">
    <?php $url = $entity_type?'report-incoming-aksessuar':'report-incoming-mato'; $form = ActiveForm::begin([
        'action' => Url::to([$url]),
        'method' => 'get',
        'id' => 'ip-search-form',
...
//                    ]);
    ...
    <?= $form->field($model, 'document_type')->hiddenInput(['value' => 1])->label(false) ?>
    <?php ActiveForm::end(); ?>
<!--    --><?php //Pjax::end()?>
</div>
