...
<!--    --><?php //Pjax::begin(['id' => 'reportSearchFormMoving'])?>
    <?php $url = $entity_type?'report-moving-aksessuar':'report-inside-moving-mato'; $form = ActiveForm::begin([
        'action' => Url::to([$url]),
        'method' => 'get',
        'id' => 'ip-search-form',
...
//                    ]);
    ...
    <?= $form->field($model, 'document_type')->hiddenInput(['value' => \app\modules\toquv\models\ToquvDocuments::DOC_TYPE_INSIDE_MOVING])->label(false) ?>
    <?php ActiveForm::end(); ?>
<!--    --><?php //Pjax::end()?>
</div>