...
?>
    <div class="row">
        <div class="col-md-3">
            ...
            <?= $form->field($model, 'document_type')->hiddenInput(['value' => $model::DOC_TYPE_SERVICE])->label(false) ?>
        </div>
        <div class="col-md-3">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?= $form->field($model, 'musteri_id')->widget(Select2::className(),[
                ...
                'options' => [
                    'placeholder' => Yii::t('app', "Kerakli mijozni tanlang")
                ],
                'pluginOptions' => [
                    'allowClear' => true
                ],
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?= $form->field($model, 'musteri_responsible')->textarea() ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                            ...
                            'ajax' => [
                                ...
                                'data' => new JsExpression("function(params) { 
                                    ...
                                    if(deptId === ''){
                                        ...
                                        return { q:params.term, dept:deptId, type:1, index:currIndex};
                                    }
