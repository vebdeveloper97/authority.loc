...
<div class="toquv-documents-index">
    <?php if(Yii::$app->user->can('toquv-documents/hisobdan_chiqarish/create')):?>
        <p class="pull-right">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'add_info',
                'contentOptions' => ['style' => 'white-space: normal;max-width:500px;'],
            ],
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('toquv-documents/hisobdan_chiqarish/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('toquv-documents/hisobdan_chiqarish/update') && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('toquv-documents/hisobdan_chiqarish/delete') && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
