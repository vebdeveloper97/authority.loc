        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'visibleButtons' => [
                        'view' => Yii::$app->user->can('toquv-documents/kochirish_aksessuar/view'),
                        'update' => function($model) {
                            return Yii::$app->user->can('toquv-documents/kochirish_aksessuar/update') && $model->status !== $model::STATUS_SAVED;
                        },
                        'delete' => function($model) {
                            return Yii::$app->user->can('toquv-documents/kochirish_aksessuar/delete') && $model->status !== $model::STATUS_SAVED;
                        }
                    ],
                    'buttons' => [
