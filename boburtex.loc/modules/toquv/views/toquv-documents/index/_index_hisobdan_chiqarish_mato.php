    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' =>  Yii::$app->user->can('toquv-documents/hisobdan_chiqarish_mato/view'),
                    /*'update' => function($model) {
                        return Yii::$app->user->can('toquv-documents/hisobdan_chiqarish_mato/update') && $model->status < $model::STATUS_SAVED;
                    },*/
                ],
                'buttons' => [
