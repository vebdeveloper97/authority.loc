...
<div class="toquv-documents-index">
    ...
    <?php if(Yii::$app->user->can('toquv-documents/kochirish_ip/create')):?>
        <p class="pull-right">
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    ...
                    $status = '<span class="fa fa-info-circle text-yellow"></span>';
                    switch ($model->action){
                        case 11:
                            $status = '<span class="fa fa-check text-success"></span>';
                            break;
                        case 12:
                            $status = '<span class="fa fa-remove text-danger"></span>';
                            break;
                    }
                    return $status.'&nbsp;&nbsp;'.$doc;
                },
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('toquv-documents/kochirish_ip/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('toquv-documents/kochirish_ip/update') && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('toquv-documents/kochirish_ip/delete') && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
