...
<div class="toquv-documents-index">
    ...
    <?php if(Yii::$app->user->can('toquv-documents/xizmat_ip/create')):?>
        <p class="pull-right">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('toquv-documents/xizmat_ip/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('toquv-documents/xizmat_ip/update') && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('toquv-documents/xizmat_ip/delete') && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
