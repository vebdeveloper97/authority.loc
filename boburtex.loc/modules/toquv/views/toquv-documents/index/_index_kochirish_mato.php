        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'visibleButtons' => [
                        'view' => Yii::$app->user->can('toquv-documents/kochirish_mato/view'),
                        'update' => function($model) {
                            return Yii::$app->user->can('toquv-documents/kochirish_mato/update') && $model->status !== $model::STATUS_SAVED;
                        },
                        'delete' => function($model) {
                            return Yii::$app->user->can('toquv-documents/kochirish_mato/delete') && $model->status !== $model::STATUS_SAVED;
                        },
                    ],
                    'buttons' => [
