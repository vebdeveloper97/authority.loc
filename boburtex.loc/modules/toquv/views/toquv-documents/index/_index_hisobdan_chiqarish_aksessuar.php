    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' =>  Yii::$app->user->can('toquv-documents/hisobdan_chiqarish_aksessuar/view'),
                    /*'update' => function($model) {
                        return Yii::$app->user->can('toquv-documents/hisobdan_chiqarish_aksessuar/update') && $model->status < $model::STATUS_SAVED;
                    },*/
                ],
                'buttons' => [
