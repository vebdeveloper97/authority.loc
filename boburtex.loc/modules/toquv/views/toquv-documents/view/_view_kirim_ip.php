...
$this->title = Yii::t('app','{doc_type}  №{number} - {date}',[
        ...
        'date' => date('d.m.Y H:i', strtotime($model->reg_date)),
...
<div class="toquv-documents-view">
    ...
    <div class="pull-right no-print" style="margin-bottom: 15px;">
        <?php if (Yii::$app->user->can('toquv-documents/kirim_ip/update')): ?>
            ...
            <?php endif;?>
        <?php endif;?>
        <?php if (Yii::$app->user->can('toquv-documents/kirim_ip/delete')): ?>
            <?php if($model->status != $model::STATUS_SAVED):?>
