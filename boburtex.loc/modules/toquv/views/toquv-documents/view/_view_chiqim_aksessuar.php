...
<div class="toquv-documents-view">
    <div class="pull-right no-print" style="margin-bottom: 15px;">
        ...
        <?php if (Yii::$app->user->can('toquv-documents/chiqim_aksessuar/update')): ?>
            ...
            <?php endif;?>
        <?php endif;?>
        <?= Html::button('<span class="fa fa-2x fa-print"></span>', ['class' => 'btn btn-primary print-btn-aks btn-sm']) ?>
    </div>
    ...
    <div class="center-text">
        <table class="table table-striped table-bordered" id="ipKirimViewTable">
            ...
            <tr>
                ...
                <th rowspan="2"><?php echo Yii::t('app',"Narx (So'm)")?></th>
                <th rowspan="2"><?php echo Yii::t('app',"Narx ($)")?></th>
            ...
            <tr>
                ...
                <td style="font-weight:bold;font-size:1.1em"><?= number_format($totalSum,3,'.',' '); ?></td>
                <td style="font-weight:bold;font-size:1.1em"><?= number_format($totalUsd,3,'.',' '); ?></td>
            </tr>
            </tfoot>
        </table>
    </div>
