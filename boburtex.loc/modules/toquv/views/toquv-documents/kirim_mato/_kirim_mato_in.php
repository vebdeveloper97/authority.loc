...
<div class="row">
    <div class="col-md-6">
        <?= $form->field($model, 'from_department')->dropDownList($model->getDepartments(true, ToquvDepartments::findOne(['token'=>'TOQUV_MATO_SEH'])['id'])) ?>
    </div>
    <div class="col-md-6">
...
<?php
$urlRemain = Url::to(['ajax-request-mato-incoming' ,'slug' => $this->context->slug]);
