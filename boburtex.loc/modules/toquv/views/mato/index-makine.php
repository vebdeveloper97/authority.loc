    ...
    <div class="toquv-kalite-index">
        ...
        <div class="row no-print" style="position: absolute;right: 100px;width: 400px;">
            <div class="col-lg-6 noPadding" style="padding-top: 25px;text-align: right">
                <a class="btn btn-default" href="<?=($mak)?Url::to('index'):Url::to(['index','mak'=>1])?>"><?php echo Yii::t('app',"Umumiy ko'rsatish")?></a>
            </div>
            <div class="col-lg-6">
                <form action="" method="GET">
                    ...
                    <div class="input-group" style="width: 200px">
                        ...
                        <input type="hidden" name="mak" value="<?=($_GET['mak'])?$_GET['mak']:1?>">
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => \kartik\select2\Select2::widget([
                        'model' =>  $searchModel,
                        'attribute' => 'toquv_makine_id',
                        'data' => [[''=>Yii::t('app','Barchasi')],\app\modules\toquv\models\ToquvKalite::getMakineList()],
                        'language' => 'ru',
                        'options' => [
                            'prompt' => '',
                        ],
                ...
                /*[
                    ...
                    'value' => function($m){
                        return ToquvKalite::getOneKalite($m['tir_id'],1)['summa'];
                    },
                    'contentOptions' => [
                        'class' => 'summa_seh',
                        'style' => 'font-weight:bold'
                ...
                [
                    ...
                    'value' => function($model){
                        $diff = $model['quantity'] - $model['summa'];
