...
use app\modules\toquv\models\ToquvUsersSearch;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\Response;

/**
 * ToquvUsersController implements the CRUD actions for Users model.
 */
class ToquvUsersAksController extends BaseController
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new ToquvUsersSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams,['TOQUV_AKSESSUAR']);
    ...
    public function actionCreate()
    {
        ...
        $model->user_role = 8;
        $model->add_info = 'Toquv';
        $model->lavozimi = 'Toquvchi';
        $info->smena = "A";
...
//        $model->scenario = Users::SCENARIO_UPDATE;
    ...
    public function actionExportExcel(){
        ...
        $filename = "toquv-users_".date("d-m-Y-His").".xls";
