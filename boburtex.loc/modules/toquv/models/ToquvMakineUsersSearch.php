...
/**
 * ToquvMakineUsersSearch represents the model behind the search form of `app\modules\toquv\models\ToquvMakineUsers`.
 */
class ToquvMakineUsersSearch extends Users
{
    public $tabel;
    /**
     * {@inheritdoc}
    ...
    /*public function search($params)
    {
        ...
        $query->andFilterWhere([
            'toquv_makine_id' => $this->toquv_makine_id,
            'users_id' => $this->users_id,
        ]);

        return $dataProvider;
    }*/
    public function search($params,$token=['TOQUV_KALITE'])
    {
