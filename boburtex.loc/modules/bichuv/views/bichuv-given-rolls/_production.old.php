...
<?php if ($t == 1): ?>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <?= $form->field($model, 'model_var_id')->widget(Select2::className(),[
                        'options' => [ 'multiple' => true, 'id' => 'modelVarId'],
                    ]) ?>
                </div>
            </div>
            <div class="row">
        ...
        <div class="kirim-mato-box-nastel">
            <div class="document-items-nastel">
                ...
                <?= CustomTabularInput::widget([
                    ...
                    'rowOptions' => [
                        'id' => 'row{multiple_index_documentitems_acs_id}',
                        'data-row-index' => '{multiple_index_documentitems_acs_id}'
                    ],
                    'columnClass' => \app\components\CustomContent::className(),
                    'max' => 100,
                    'min' => 0,
                    ...
                    'columns' => [
                        ...
                        [
                            'name' => 'bichuv_detail_type_id',
                            'type' => 'hiddenInput',
                            'defaultValue' => \app\modules\bichuv\models\BichuvDetailTypes::getType('ACCESSORY')
                        ],
                        /*[
                            'name' => 'entity_id',
                            'type' => Select2::className(),
                        ...
                        [
                            'name' => 'entity_id',
                            'type' => Select2::className(),
                            'title' => Yii::t('app', 'Aksesuar nomi'),
                            'options' => [
                                'data' => \app\modules\bichuv\models\BichuvDoc::getAccessories(null, true, true),
                                'options' => [
                                    'multiple' => false,
                                    'class' => 'mato-kirim-select2',
    ...
    <script>
        ...
        $('body').delegate('.plus_size_acs', 'click', function (e) {
            ...
            let inputList = "";
            for (var prop in sizeList) {
                let size_div = modal_body.find('.size_acs_div_'+prop);
                if(size_div.length==0) {
                    inputList += "<div class='row parentRow size_acs_div_" + prop + "' style='margin-bottom: 6px;'>\n" +
                        "            <div class='col-md-5 noPaddingRight'>\n" +
                        "                <input type='text' class='form-control' value='" + sizeList[prop] + "' disabled>\n" +
                        "            </div>\n" +
                        "            <div class='col-md-5 noPaddingRight'>\n" +
                        "                <input type='text' class='form-control size_input isInteger' data-count-size='count_size_acs_" + indeks + "' name='BichuvGivenRollItemsAcs[" + indeks + "][child]["+prop+"]' value=''>\n" +
                        "            </div>\n" +
                        "<div class='col-md-2'>\n" +
                        "               <button type='button' class='btn btn-xs btn-danger remove_size'>\n"+
                        "<i class='fa fa-remove'></i>\n" +
        ...
        $('body').delegate('#barcodeInput', 'keyup', function (e) {
            ...
            if (e.which == 13) {
                ...
                let existParties = $('#documentitems_id').find('.model-entity-id');
                let args = {};
                if (existParties) {
                    args.party = {};
