...
//        'action' => Url::to(['report-accs-moving']),
    ...
    <div class="form-group row">
        ...
        ?>
        <div class="col-md-3">
            <?= $form->field($model, 'size')->widget(Select2::class, [
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'department')->widget(Select2::class, [
                'data' => \app\modules\bichuv\models\BichuvDoc::getDepartmentByToken(["PECHAT",'NAQSH'],true),
                'options' => [
                    'multiple' => true,
                    'prompt' => Yii::t('app', 'All'),
                ],
    ...
    <div class="row">
        <div class="form-group col-md-12">
            <div class="col-md-12" style="margin-top: 25px;">
                ...
                <?= Html::a('Filterni bekor qilish', Url::to(['reports/report-bichuv-slice-accept']), ['class' => 'btn btn-danger']) ?>
            </div>
        </div>
    </div>
