...
$heading = '<i class="fa fa-pie-chart"></i> ' .  Yii::t('app', 'Ko\'chirish');
...
$gridColumns = [
    ...
    [
        'attribute' => 'invalid_quantity',
        'vAlign' => 'middle',
        'width' => '180px',
        'label' => Yii::t('app' ,'Yaroqsiz miqdor')
    ],
    [
        'attribute' => 'add_info',
        'vAlign' => 'middle',
...
$this->title = Yii::t('app',"Xisobot (Ko'chirish)");
?>
<div class="no-print">
    <div class="box box-info box-solid">
        ...
        <div class="box-body">
            <?= $this->render('search/_search_print_transfer', [
                'model' => $searchModel
            ]) ?>
        </div>
    </div>
