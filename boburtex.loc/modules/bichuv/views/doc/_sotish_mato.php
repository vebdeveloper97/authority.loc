...
<div class="row">
    <div class="col-md-3">
        ...
        <?= $form->field($model, 'document_type')->hiddenInput(['value' => $model::DOC_TYPE_SELLING])->label(false) ?>
    </div>
    <div class="col-md-3">
...
//            'data' => $model->getUserDepartmentByUserId(Yii::$app->user->id, ToquvUserDepartment::FOREIGN_DEPARTMENT_TYPE),
            'data' => \app\modules\bichuv\models\BichuvMusteri::getMyMusteri(),
        ])->label(Yii::t('app', "Musteri")) ?>
    </div>
</div>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    $sub = $model->getMatoEnGramaj($model->entity_id);
            ...
            [
                ...
                'title' => Yii::t('app','Rulon soni(Qoldiq)'),
                'options' => [
            ...
            [
                'name' => 'roll_weight',
                'title' => Yii::t('app', "Mavjud Qoldiq (kg)"),
                'defaultValue' => 0,
                'options' => [
                    'disabled' => true,
            ...
            [
                'name' => 'quantity',
                'title' => Yii::t('app', 'Mato miqdori (kg)'),
                'options' => [
                ...
                if (data.status == 1) {
                    ...
                    for (let i in data.items){
                        ...
                        if(item.rulon_count > 0 && item.rulon_kg > 0) {
                            ...
                            lastObj.find('.roll-party').val(item.partiya_no+'/'+item.musteri_party_no);
                            lastObj.find('.party-no').val(item.partiya_no);
                            ...
                            lastObj.find('.price-sum').val("0");
                            lastObj.find('.price-usd').val("0");
                        }else{
                            isEmpty = true;
                        }
                    }
