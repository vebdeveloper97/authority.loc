...
<div class="row">
    <div class="col-md-3">
        ...
        <?= $form->field($model, 'document_type')->hiddenInput(['value' => $model::DOC_TYPE_REPAIR])->label(false) ?>
    </div>
    <div class="col-md-3">
...
<div class="row">
    <div class="col-md-6">
        <?= $form->field($model, 'from_department')->widget(Select2::className(),[
            'data' => $model->getDepartmentByToken(['BICHUV_MATO_OMBOR'], true)
        ]) ?>
    </div>
    <div class="col-md-6">
        <?= $form->field($model, 'to_department')->widget(Select2::className(),[
            'data' => $model->getDepartmentByToken(['BOYOQ'], true),
        ]) ?>
    </div>
</div>
