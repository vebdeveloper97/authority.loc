...
if (isset($_POST['department_id'])){
    $model->from_department = $_POST['department_id'];
}
?>
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'doc_number')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'document_type')->hiddenInput(['value' => $model::DOC_TYPE_OUTGOING])->label(false) ?>
        </div>
        <div class="col-md-3">
...
$this->registerJs("$('#{$formId}').keypress(function(e) {
    ...
    $.fn.calcRemain = function(remainInput) {
         ...
         if(parseFloat(quantityInput.val()) > 0 && parseFloat(remainInput.val()) > 0){
