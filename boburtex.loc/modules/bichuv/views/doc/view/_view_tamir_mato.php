...
<div class="toquv-documents-view">
    ...
    <div class="pull-right" style="margin-bottom: 15px;">
        ...
        <?php if (Yii::$app->user->can('doc/tamir_mato/update')): ?>
            <?php if($model->status != $model::STATUS_SAVED):?>
                ...
                <?php if (Yii::$app->user->can('doc/tamir_mato/delete')): ?>
    ...
    <table class="table table-bordered table-responsive">
        ...
        <tr>
            <td colspan="2"><strong><?= Yii::t('app', 'Status')?></strong>:
                <?php
                if($model->toquv_doc_id){
                    if($model->toquvDoc->status == 3){
                        echo Yii::t('app','Qabul qilingan');
                    }else{
                        echo Yii::t('app',"Jo'natildi");
                    }
                }
                ?>
            </td>
