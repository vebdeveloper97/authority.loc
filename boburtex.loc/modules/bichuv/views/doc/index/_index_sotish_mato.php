    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return \app\modules\bichuv\models\BichuvMusteri::getMusteriById($model->to_department)['name'];
//                    return "<b>".$model->toDepartment->name ."</b><br><small><i>". $model->toEmployee->user_fio . "</i></small>";
                },
//                'format' => 'raw',
//                'filter' => $searchModel->getMusteriById(true),
            ],
            [
                'attribute' => 'party',
            ...
            [
                'label' => Yii::t('app','Narxi (UZS / USD)'),
                'value' => function($model, $key ,$index){
                    return $model->bichuvDocItems[$index]->price_sum. " / " . $model->bichuvDocItems[$index]->price_usd;
                }
            ],
            [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('doc/sotish_mato/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('doc/sotish_mato/update') && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('doc/sotish_mato/delete') && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
