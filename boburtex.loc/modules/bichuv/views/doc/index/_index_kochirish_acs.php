...
<div class="toquv-documents-index">
    ...
    <?php if(Yii::$app->user->can('doc/kochirish_acs/create')):?>
        <p class="pull-right">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('doc/kochirish_acs/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('doc/kochirish_acs/update') && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('doc/kochirish_acs/delete') && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
