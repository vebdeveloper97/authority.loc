...
<div class="toquv-documents-index">
    <?php if(Yii::$app->user->can('doc/kochirish_kesim/create')):?>
        <p class="pull-right">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('doc/kochirish_kesim/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('doc/kochirish_kesim/update') && $model->status !== $model::STATUS_SAVED && $model->type !== 4;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('doc/kochirish_kesim/delete') && $model->status !== $model::STATUS_SAVED && $model->type !== 4;
                    }
                ],
                'buttons' => [
