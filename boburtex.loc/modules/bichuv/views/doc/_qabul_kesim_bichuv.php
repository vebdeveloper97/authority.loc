    ...
    <?php if($t == 1):?>
        <div class="row">
            <div class="col-md-3">
                ...
                <?= $form->field($model, 'document_type')->hiddenInput(['value' => $model::DOC_TYPE_ACCEPTED_FROM_BICHUV])->label(false) ?>
        ...
        <div class="document-items">
            ...
            <?= CustomTabularInput::widget([
                ...
                'columns' => [
                    ...
                    [
                        'name' => 'fact_quantity',
                        'title' => Yii::t('app', 'Miqdori (fact)'),
                        'options' => [
                            'class' => 'tabular-cell-mato',
                        ],
                        'value' => function ($model) {
                            return (!empty($model->fact_quantity)) ? $model->fact_quantity : number_format($model->quantity, 0,'','');
                        }
                    ],
                    [
                            'name' => 'add_info',
