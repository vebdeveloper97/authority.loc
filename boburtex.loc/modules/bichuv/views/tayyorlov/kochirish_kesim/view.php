...
$tayyorlov = \app\modules\toquv\models\ToquvDepartments::findOne(['token'=>'TAYYORLOV'])['id'];
$print = \app\modules\toquv\models\ToquvDepartments::findOne(['token'=>'PECHAT'])['id'];
$pattern = \app\modules\toquv\models\ToquvDepartments::findOne(['token'=>'NAQSH'])['id'];
?>
<div class="toquv-documents-view">
    <div class="pull-right" style="margin-bottom: 15px;">
        <?=  Html::a(Yii::t('app', 'Back'), ["index",'slug' => $this->context->slug], ['class' => 'btn btn-info']) ?>
        <?php if (Yii::$app->user->can('tayyorlov/kochirish_kesim/update')): ?>
            <?php if ($model->status < $model::STATUS_SAVED): ?>
                ...
                <?php if (Yii::$app->user->can('tayyorlov/kochirish_kesim/delete')): ?>
