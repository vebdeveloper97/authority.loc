...
<div class="toquv-documents-index">
    <?php if(Yii::$app->user->can('tayyorlov/kochirish_kesim/create')):?>
        <p class="pull-right">
...
//                    $result = null;
//                    switch ($model->type){
//                        case 1: $result = Yii::t('app','Kesim'); break;
//                        case 2: $result = Yii::t('app','Aksessuar'); break;
//                        case 3: $result = Yii::t('app','Mato'); break;
//                    }
//                    return $result;
//                },
//                'filter' => $searchModel->getEntityType()
//            ],
            [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('tayyorlov/kochirish_kesim/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('tayyorlov/kochirish_kesim/update') && $model->status !== $model::STATUS_SAVED && $model->type !== 4;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('tayyorlov/kochirish_kesim/delete') && $model->status !== $model::STATUS_SAVED && $model->type !== 4;
                    }
                ],
                'buttons' => [
