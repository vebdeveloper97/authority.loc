...
<div class="bichuv-report-index">
        ...
        <?= Collapse::widget([
            'items' => [
                [
                    ...
                    'content' => $this->render('_search_report_accepted_slice', [
                            'model' => $searchModel
                    ]),
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'qiyqim_mato',
            'value' => function($model){
                return $model['qiyqim_mato'];
            },
            'label' => Yii::t('app', 'Qiyqim mato'),
            'contentOptions' => [
        ...
        [
            'label' => Yii::t('app',"Qabul qilingan kesim"),
            'value' => function($model){
                return $model['ish_soni'];
            },
            'contentOptions' => [
                'style' => 'font-weight:bold'
            ],
