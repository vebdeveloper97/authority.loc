...
<div class="toquv-item-balance-search">
    <?php $form = ActiveForm::begin([
        'action' => Url::to(['tikuv-doc-inform']),
        'method' => 'get',
        'id' => 'ip-search-form',
    ...
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'departament')->widget(Select2::className(), [
                'data' => $model->getDepartmentByToken(['TIKUV_2_FLOOR','TIKUV_3_FLOOR']),
                'options' => ['placeholder' => ''],
                'pluginOptions' => [
                    'allowClear' => true
                ],
        ...
        <div class="col-md-3">
            <?= $form->field($model,'konveyer')->textInput()?>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3" style="margin-top: 20px; display: flex">
            ...
            <?= Html::a('Filterni bekor qilish', Url::to(['tikuv-doc-inform']), ['class' => 'btn btn-danger']) ?>
        </div>
    </div>
    <?php ActiveForm::end(); ?>
</div>
