...
<div class="doc-view">
    ...
    <div class="pull-right" style="margin-bottom: 15px;">
        <?php if (Yii::$app->user->can('doc/update')): ?>
            <?php  if ($model->status != $model::STATUS_SAVED): ?>
                <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
            <?php endif; ?>
        <?php endif; ?>
        <?php if (Yii::$app->user->can('doc/delete')): ?>
            <?php  if ($model->status != $model::STATUS_SAVED): ?>
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => function($model){
                    return (app\modules\tikuv\models\TikuvDoc::getStatusList($model->status))?app\modules\tikuv\models\TikuvDoc::getStatusList($model->status):$model->status;
                }
            ],
            [
