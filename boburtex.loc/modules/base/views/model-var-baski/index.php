...
/* @var $searchModel app\modules\base\models\ModelVarBaskiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Model Var Baskis');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="model-var-baski-index">
    <?php if (Yii::$app->user->can('model-var-baski/create')): ?>
    ...
    <?php Pjax::begin(['id' => 'model-var-baski_pjax']); ?>
        ...
        'columns' => [
            ...
            [
                  ...
                  'value' => function($model){
                        $img = '';
                        foreach ($model->modelVarBaskiRelAttaches as $image){
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('model-var-baski/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('model-var-baski/update'); // && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('model-var-baski/delete'); // && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
...
<?=  \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'model-var-baski',
    'crud_name' => 'model-var-baski',
    'modal_id' => 'model-var-baski-modal',
    'modal_header' => '<h3>'. Yii::t('app', 'Model Var Baski') . '</h3>',
    'active_from_class' => 'customAjaxFormBaski',
    'update_button' => 'update-dialog',
    'create_button' => 'create-dialog',
    'view_button' => 'view-dialog',
    'delete_button' => 'delete-dialog',
    'modal_size' => 'modal-md',
    'grid_ajax' => 'model-var-baski_pjax',
