...
<div class="pull-right" style="margin-top: -22px;">
    <?php if (P::can('model-orders/update') && $model->orders_status != ModelOrders::STATUS_INACTIVE): ?>
...
$gridColumns = [
    ...
    [
        'attribute' => 'unit',
        'label' => Yii::t('app', "O'lchov birligi"),
        'contentOptions' => ['style' => 'width:5%;'],
        'value' => function($model){
            return $model['unit'];
