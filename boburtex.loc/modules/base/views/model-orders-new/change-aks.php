                ...
                <table id="table_acs_<?=$key?>" class="multiple-input-list table table-condensed table-renderer">
                    ...
                    <?php if(!empty($item->modelOrdersItemsAcs)){
                        ...
                        foreach ($item->modelsList->modelsAcs as $row => $item_acs) {*/?><!--
                            <tr class="multiple-input-list__item row_ " data-row-index=" ">
                                <td class="list-cell__artikul"> <span type="text" class="form-control" disabled=""> </span> </td>
                                <td class="list-cell__name"> <span type="text" class="acs_input form-control" disabled=""> </span>
                                    <input type="hidden" class="acs_input form-control" name="ModelOrdersItems[ ][acs][ ][id]" value=" ">
                                    <input type="hidden" class="acs_input form-control" name="ModelOrdersItems[ ][acs][ ][unit_id]" value=" ">
                                </td>
                                <td class="list-cell__turi"> <span type="text" class="acs_input form-control" disabled=""> </span> </td>
                                <td class="list-cell__qty">
                                    <input type="text" class="acs_input form-control number" name="ModelOrdersItems[ ][acs][ ][qty]" value=" ">
                                </td>
                                <td class="list-cell__unit_id"> <span type="text" class="acs_input form-control" disabled=""> </span> </td>
                                <td class="list-cell__barcod"> <span type="text" class="acs_input form-control" disabled=""> </span> </td>
                                <td class="list-cell__add_info">
                                    <input type="text" class="acs_input form-control" name="ModelOrdersItems[ ][acs][ ][add_info]" value=" ">
                                </td>
                                <td class="list-cell__acs_image"> <img class="imgPreview pr_image" src=" "> </td>
                                <td class="list-cell__button">
                                    <div class="multiple-input-list__btn js-input-remove btn btn-danger removeTr"> <i class="glyphicon glyphicon-remove"></i> </div>
                                </td>
                            </tr>
