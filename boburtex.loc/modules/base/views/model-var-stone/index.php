...
/* @var $searchModel app\modules\base\models\ModelVarStoneSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Model Var Stones');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="model-var-stone-index">
    <?php if (Yii::$app->user->can('model-var-stone/create')): ?>
    ...
    <?php Pjax::begin(['id' => 'model-var-stone_pjax']); ?>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    $img = '';
                    foreach ($model->modelVarStoneRelAttaches as $image){
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('model-var-stone/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('model-var-stone/update'); // && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('model-var-stone/delete'); // && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
...
<?=  \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'model-var-stone',
    'crud_name' => 'model-var-stone',
    'modal_id' => 'model-var-stone-modal',
    'modal_header' => '<h3>'. Yii::t('app', 'Model Var Stone') . '</h3>',
    'active_from_class' => 'customAjaxFormStone',
    'update_button' => 'update-dialog',
    'create_button' => 'create-dialog',
    'view_button' => 'view-dialog',
    'delete_button' => 'delete-dialog',
    'modal_size' => 'modal-lg',
    'grid_ajax' => 'model-var-stone_pjax',
