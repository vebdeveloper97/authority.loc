...
$urlColor = Yii::$app->urlManager->createUrl('base/model-var-rotatsion/ajax-request');
?>

<div class="model-var-rotatsion-form">

    <?php $form = ActiveForm::begin(['options' => ['data-pjax' => true,'class'=> 'customAjaxFormRotatsion']]); ?>
