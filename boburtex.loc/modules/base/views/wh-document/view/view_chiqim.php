...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Chiqim'), 'url' => ['index', 'slug' => $this->context->slug]];
...
<div class="wh-document-view">
    ...
    <div class="pull-right" style="margin-bottom: 15px;">
        <?php if (Yii::$app->user->can('wh-document/chiqim/update')): ?>
            ...
            <?php endif; ?>
        <?php endif; ?>
        <?php if (Yii::$app->user->can('wh-document/chiqim/delete')): ?>
            <?php  if ($model->status != $model::STATUS_SAVED): ?>
