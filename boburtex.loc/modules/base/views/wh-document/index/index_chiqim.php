...
<div class="wh-document-index">
    ...
    <p class="pull-right no-print">
        <?php if (Yii::$app->user->can('wh-document/chiqim/create')): ?>
            <?= Html::a('<span class="fa fa-plus"></span>', ['wh-document/chiqim/create'], ['class' => 'btn btn-sm btn-success']) ?>
        <?php endif; ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('wh-document/chiqim/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('wh-document/chiqim/update') && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('wh-document/chiqim/delete') && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
