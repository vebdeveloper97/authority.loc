...
$this->title = Yii::t('app', 'Aralashtirish');
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><?= Yii::t('app', 'Aralashtirish') ?></a></li>
<!--        <li class="">-->
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            <div class="wh-document-index">
                <?php if (P::can('wh-document/mixing/create')): ?>
                    <p class="pull-right no-print">
                        <?= Html::a('<span class="fa fa-plus"></span>', ['wh-document/mixing/create'], ['class' => 'btn btn-sm btn-success']) ?>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'visibleButtons' => [
                                'view' => P::can('wh-document/mixing/view'),
                                'update' => function($model) {
                                    return P::can('wh-document/mixing/update') && $model->status !== $model::STATUS_SAVED;
                                },
                                'delete' => function($model) {
                                    return P::can('wh-document/mixing/delete') && $model->status !== $model::STATUS_SAVED;
                                }
                            ],
                            'buttons' => [
