...
/* @var $searchModel app\modules\base\models\ModelVarPrintsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Model Var Prints');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="model-var-prints-index">
    <?php if (Yii::$app->user->can('model-var-prints/create')): ?>
    ...
    <?php Pjax::begin(['id' => 'model-var-prints_pjax']); ?>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    $img = '';
                    foreach ($model->modelVarPrintRelAttaches as $image){
                        if($image->attachment["path"]){
                            $img .= '<img class="imgPreview img-thumbnail" src="/web/'.$image->attachment["path"].'" style="width:auto;height:40px;">';
                        }
                    }
                    return '
            ...
            [
                ...
                'visibleButtons' => [
                    'view' => Yii::$app->user->can('model-var-prints/view'),
                    'update' => function($model) {
                        return Yii::$app->user->can('model-var-prints/update'); // && $model->status !== $model::STATUS_SAVED;
                    },
                    'delete' => function($model) {
                        return Yii::$app->user->can('model-var-prints/delete'); // && $model->status !== $model::STATUS_SAVED;
                    }
                ],
                'buttons' => [
...
<?=  \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'model-var-prints',
    'crud_name' => 'model-var-prints',
    'modal_id' => 'model-var-prints-modal',
    'modal_header' => '<h3>'. Yii::t('app', 'Model Var Prints') . '</h3>',
    ...
    'modal_size' => 'modal-md',
    'grid_ajax' => 'model-var-prints_pjax',
