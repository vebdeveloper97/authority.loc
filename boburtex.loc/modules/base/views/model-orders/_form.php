                ...
                '                                   <input type=\"text\" class=\"acs_input form-control\" name=\"ModelOrdersItems['+indeks+'][acs]['+row_index+'][add_info]\" value=\"'+pr_add_info+'\">' +
                    ...
                    <div class="col-md-1 col-w-12">
                        <?/*= $form->field($models, 'model_var_id')->widget(Select2::className(), [
                            ...
                            'options' => [
                                'id' => 'modelVar0',
                                'name' => 'ModelOrdersItems[0][model_var_id]',
                                'indeks' => 0,
                                'class' => 'rmModelVar'
                            ],
                            'pluginOptions' => [
                    ...
                    <!--<div class="col-md-1 col-w-12" style="width: 80px;">
                        <?/*= $form->field($models, 'finish_en')->textInput([
                            'id' => 'model_finish_en_0',
                            'name' => 'ModelOrdersItems[0][finish_en]',
                            'indeks' => 0,
                        ]);
                        */?>
                    </div>
                    <div class="col-md-1 col-w-12" style="width: 80px;">
                        <?/*= $form->field($models, 'finish_gramaj')->textInput([
                            'id' => 'model_finish_gramaj_0',
                            'name' => 'ModelOrdersItems[0][finish_gramaj]',
                            'indeks' => 0,
                        ]);
                        */?>
                    </div>-->
