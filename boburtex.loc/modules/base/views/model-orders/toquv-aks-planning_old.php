                        ...
                        <?php foreach ($item->modelOrdersItemsSizes as $size):
                            if($m['rm']){
                                ...
                                <div class="row planParent">
                                    ...
                                    <!--<div class="col-md-1">
                                        <?/*= $form->field($models, 'finished_fabric')->textInput(['class'=>'number required form-control','id'=>'modelordersplanning-'.$key.'-'.$key.'-size-'.$s_id.'-finished_fabric'.$n,'name'=>"ModelOrdersPlanning[{$key}][child][{$n}][size][{$s_id}][finished_fabric]",'value'=>$plan['finished_fabric']])->label(false)*/?>
                                    </div>-->
                                    <div class="col-md-1">
