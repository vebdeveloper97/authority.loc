    ...
    <div class="model-orders-form">
        <?php $form = ActiveForm::begin([
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'add_info')->textarea(['rows' => 3,'disabled' => $disabled]) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                                        ...
                                        <div class="col-md-12">
                                            <?= $form->field($models, 'size_collections_id',['template'=>"<div><div class='col-md-6 text-right'>{label}</div><div class='col-md-6 noPaddingLeft'>{input}</div></div>"])->widget(Select2::className(), [
                                                ...
                                                'addon' => [
                                                    'append' => [
                                                        'content' => KHtml::button(KHtml::icon('plus'), [
                                                            'class' => 'showModalButton3 btn btn-success btn-sm size-collection',
                                                            'style' => 'width:15px; padding:2px; font-size: 8px',
                                                            'title' => Yii::t('app', 'Create'),
                                                            'value' => Url::to(['/base/size-collections/create']),
                                                            'data-toggle' => "modal",
                                                            'data-form-id' => 'size_coolections',
                                                            'data-input-name' => 'size_collections_id'
                                                        ]),
                                                        'asButton' => true
                                                    ]
                                                ],
                                                ...
                                                'addon' => [
                                                    'append' => [
                                                        'content' => KHtml::button(KHtml::icon('plus'), [
                                                            ...
                                                            'data-input-name' => 'modelordersitemsacs-0-application_part'
                                                        ]),
                                                        'asButton' => true
                                                    ]
                                                ],
