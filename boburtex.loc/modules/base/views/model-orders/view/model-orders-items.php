    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{new-order} {copy-order} {plus}',
                ...
                'buttons' => [
                    'new-order' => function ($url, $model) {
                      $order = ModelOrdersItems::findOne($model->id);
                      $modelOrders = ModelOrders::findOne($order->model_orders_id);
                      if($order->status == ModelOrders::STATUS_ACTIVE){
