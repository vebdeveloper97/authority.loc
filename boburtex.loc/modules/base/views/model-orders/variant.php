...
/* @var $new_variations \app\modules\base\models\ModelOrdersVariations */
    ...
    <div class="model-orders-form">
        ...
        <div>
            ...
            <?php $i = 1; foreach($old_options as $key => $item): ?>
                ...
                <?php endif; ?>
            <?php $i++; endforeach; ?>
            <?php if($new_variations !== null): ?>
                <li role="presentation">
                    <a href="#home_new" aria-controls="home" role="tab" data-toggle="tab">
                        <?=Yii::t('app', 'New Variations <span class="fa fa-spinner fa-spin text-success"></span>'); ?>
                    </a>
                </li>
            <?php endif; ?>
            </ul>
        ...
        <div class="tab-content">
            ...
            <?php endforeach; ?>
            <?php if($new_variations !== null): ?>
                <div role="tabpanel" class="tab-pane" id="home_new">
                    <?=$this->render('variant/new_options',[
                        'variant_id' => $new_variations['id'],
                        'model' => $model,
                        'moiSearchModel' => $moiSearchModel,
                        'moiDataProvider' => $moiDataProvider,
                        'id' => $new_variations['model_orders_id'],
