...
/**
 * This is the model class for table "model_var_stone_rel_attach".
 *
 * @property int $id
 ...
 */
class ModelVarStoneRelAttach extends BaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'model_var_stone_rel_attach';
    }
    ...
    {
        return [
            [['model_var_stone_id', 'attachment_id', 'is_main', 'status', 'created_by', 'created_at', 'updated_at'], 'integer'],
