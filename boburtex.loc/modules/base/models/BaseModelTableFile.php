...
/**
 * This is the model class for table "{{%base_model_table_file}}".
 *
 * @property int $id
 * @property int $doc_id
 ...
 */
class BaseModelTableFile extends BaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['doc_id', 'doc_items_id', 'attachment_id', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
