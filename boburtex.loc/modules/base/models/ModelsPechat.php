...
/**
 * This is the model class for table "models_pechat".
 *
 * @property int $id
 ...
 */
class ModelsPechat extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['models_list_id', 'width', 'height', 'models_var_id', 'attachments_id', 'base_details_list_id'], 'integer'],
            [['content'], 'string'],
