...
/**
 * This is the model class for table "model_var_rotatsion_rel_attach".
 *
 * @property int $id
 ...
 */
class ModelVarRotatsionRelAttach extends BaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'model_var_rotatsion_rel_attach';
    }
    ...
    {
        return [
            [['model_var_rotatsion_id', 'attachment_id', 'is_main', 'status', 'created_by', 'created_at', 'updated_at'], 'integer'],
