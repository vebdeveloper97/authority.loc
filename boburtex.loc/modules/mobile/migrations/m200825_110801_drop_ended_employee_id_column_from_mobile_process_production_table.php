 ...
 * - `{{%hr_employee}}`
 */
class m200825_110801_drop_ended_employee_id_column_from_mobile_process_production_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->dropColumn('{{%mobile_process_production}}', 'ended_employee_id');
    }
    ...
    {
        $this->addColumn('{{%mobile_process_production}}', 'ended_employee_id', $this->integer());
