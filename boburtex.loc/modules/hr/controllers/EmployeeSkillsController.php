...
use app\modules\hr\models\HrEmployeeSkillsSearch;
 ...
 */
class EmployeeSkillsController extends BaseController
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new HrEmployeeSkillsSearch();
    ...
    public function actionExportExcel(){
        ...
        $filename = "employee-skills_".date("d-m-Y-His").".xls";
        header('Content-Disposition: attachment;filename='.$filename .' ');
        header('Cache-Control: max-age=0');
        \moonland\phpexcel\Excel::export([
            'models' => HrEmployeeSkills::find()->select([
                'id',
            ])->all(),
            'columns' => [
                'id',
     ...
     * @param integer $id
     * @return HrEmployeeSkills the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = HrEmployeeSkills::findOne($id)) !== null) {
            return $model;
        }
