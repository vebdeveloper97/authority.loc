...
<div class="box box-primary box-solid">
    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?= $form->field($model, 'reason')->textarea(['rows' => 1])->label('Mavzu') ?>
            </div>
            <div class="col-lg-4">
...
<?= $form->field($model, 'type')->hiddenInput(['value' => \app\modules\hr\models\HrServices::SERVICE_TYPE_MALAKA_OSHIRISH])->label(false) ?>
