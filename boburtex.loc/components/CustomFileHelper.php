...
class CustomFileHelper
{
     ...
     */
    public static function findFiles($dir, $ignoredDir, $options = [])
    {
...
//            var_dump($ignoredDir);die;
            $path = $dir . DIRECTORY_SEPARATOR . $file;
            if($path!=$ignoredDir&&$path!=realpath(Yii::getAlias('@app/runtime'))&&$path!=realpath(Yii::getAlias('@app/vendor'))&&$path!=realpath(Yii::getAlias('@app/web'))) {
